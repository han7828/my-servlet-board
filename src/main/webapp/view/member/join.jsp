            ...
            <form class="validation-form" novalidate action="/member/join" method="post">
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input name="name" type="text" class="form-control" id="name" placeholder="이름을 입력해주세요" value="" required>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input name="id" type="text" class="form-control" id="id" placeholder="아이디를 입력해주세요" value="" required>
                            <div class="invalid-feedback">
                                아이디를 입력해주세요.
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input name="pw" type="password" class="form-control" id="pw" placeholder="비밀번호를 입력해주세요" value="" required>
                            <div class="invalid-feedback">
                                비밀번호를 입력해주세요.
                            </div>
                        </div>
                        <div class="col-md-6 mb-3">
                            ...
                            <input name="repw" type="password" class="form-control" id="repw" placeholder="비밀번호를 한 번 더 입력해주세요" value="" required>
                            <div class="invalid-feedback">
                                비밀번호를 입력해주세요.
                            </div>
                        </div>
...
<%--                    </div>--%>
                    ...
                    <div class="mb-4"></div>
                    <button class="btn btn-secondary btn-block" type="submit" onclick="return confirm('회원가입을 완료합니까?')">가입 완료</button>
                </form>
            </div>
        </div>
        <div class="p-2">
